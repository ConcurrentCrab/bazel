...
You can also use the environment variable `BAZEL_ROOT` to set this directory for all further
invocations. The value set by the environment variable will be overriden by a value explicitly
